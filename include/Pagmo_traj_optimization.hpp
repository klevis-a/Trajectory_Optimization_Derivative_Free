...
namespace pagmo
{
  ...
  */
  struct Pagmo_traj_optimization{
    Pagmo_traj_optimization(opt_problems::Robot_mocap_opt_problem robot_opt_problem=opt_problems::Robot_mocap_opt_problem(1),vector_double::size_type dim=2,vector_double::size_type nic=0,vector_double::size_type nec=1) : opt_problem(robot_opt_problem),m_dim(dim), m_nic(nic), m_nec(nec)
    {
